...
# ============================================================
# CITY SELECTION (NO SPECIAL PRIORITY FOR ALMATY)
# ============================================================
...
if len(df_model) < 50:
    ...
    st.error(
        f"❌ After creating lag features, only {len(df_model)} records remain."
    )
